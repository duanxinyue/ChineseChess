...
| 部分 | 版权 / 来源 | 许可证 |
|---|---|---|
| `js/position.js`、`js/board.js`、`js/search.js`、`js/book.js`、`js/cchess.js` 及 `images/`、`sounds/` | XQWLight，Copyright (C) 2004-2012 www.xqbase.com（黄晨） | GPL-2.0-or-later |
| `js/engines/eleeye/*` | ElephantEye（象眼）引擎的 WebAssembly 移植 | LGPL-2.1 |
